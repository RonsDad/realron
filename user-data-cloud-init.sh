...
apt install -y   xvfb mutter tint2 x11vnc firefox libreoffice gedit nautilus   gnome-terminal python3 python3-pip python3-venv curl wget git   build-essential xdotool scrot imagemagick unzip
